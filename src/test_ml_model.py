...
def test_model(drone_dir, bird_dir, model_path=None, use_gpu=True):
    """
    ...
    try:
        ...
        if not classifier.load(model_path or paths.BIRD_V_DRONE_MODEL):
...
if __name__ == "__main__":
    ...
    # Default paths
    drone_dir = str(paths.DRONE_DIR)
    bird_dir = str(paths.BIRD_DIR)
    model_path = str(paths.BIRD_V_DRONE_MODEL)
    use_gpu = True
